...
# 📥 Ingestion Benchmark
# -----------------------
print("🚀 Measuring Knowledge Base ingestion time in movies_kb...")

kb_query = "DESCRIBE KNOWLEDGE_BASE mindsdb.movies_kb;"
...
print("🧪 MindsDB version: ",server.status()['mindsdb_version'])
